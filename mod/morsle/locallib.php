...
require_once("$CFG->dirroot/mod/morsle/lib.php");
 ...
 */
function morsle_appears_valid_url($url) {
 ...
 * @return string
 */
function morsle_fix_submitted_url($url) {
 ...
 */
function morsle_get_full_url($url, $cm, $course, $config=null) {
    ...
    if (preg_match('/^(\/|https?:|ftp:)/i', $fullurl) or preg_match('|^/|', $fullurl)) {
        ...
        $fullurl = preg_replace_callback("/[^$allowed]/", 'morsle_filter_callback', $fullurl);
    } else {
    ...
    if (!empty($parameters)) {
        ...
        $paramvalues = morsle_get_variable_values($url, $cm, $course, $config);
 ...
 * @return string
 */
function morsle_filter_callback($matches) {
 ...
 * @return void
 */
function morsle_print_header($url, $cm, $course) {
    global $PAGE, $OUTPUT;
 ...
 * @return void
 */
function morsle_print_heading($url, $cm, $course, $ignoresettings=false) {
    global $OUTPUT;
 ...
 * @return void
 */
function morsle_print_intro($url, $cm, $course, $ignoresettings=false) {
    global $OUTPUT;
 ...
 */
function morsle_display_frame($url, $cm, $course) {
    ...
    if ($frame === 'top') {
        ...
        $exteurl = morsle_get_full_url($url, $cm, $course, $config);
 ...
 */
function morsle_get_final_display_type($url) {
    global $CFG;
 ...
 */
function morsle_get_variable_options($config) {
    global $CFG;

    $options = array();
    $options[''] = array('' => get_string('chooseavariable', 'morsle'));
    ...
    $options[get_string('modulename', 'morsle')] = array(
        'urlinstance'     => 'id',
        'urlcmid'         => 'cmid',
 ...
 */
function morsle_get_variable_values($url, $cm, $course, $config) {
    global $USER, $CFG;
    ...
    if (!empty($config->secretphrase)) {
        $values['encryptedcode'] = morsle_get_encrypted_parameter($url, $config);
    }
 ...
 * @return string
 */
function morsle_get_encrypted_parameter($url, $config) {
    global $CFG;
 ...
 */
function morsle_guess_icon($fullurl) {
    global $CFG;
    require_once("$CFG->libdir/filelib.php");
...
function morsle_get_doc_title($url) {
